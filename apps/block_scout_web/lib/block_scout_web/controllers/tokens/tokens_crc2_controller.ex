defmodule BlockScoutWeb.TokensCRC2Controller do
  ...
  def index(conn, %{"type" => "JSON"} = params) do
    ...
    tokens = Chain.list_top_tokens_crc2(filter, paging_params)
    ...
    Map.put(params, "cur_page_number","2")
  ...
  def index(conn, _params) do
    render(conn, "index.html", current_path: Controller.current_full_path(conn),cur_page_number:"2")
  end
end
